...
class Item {
    ...
    itemElement() {
        ...
        const addButton = itemDiv.querySelector(`#add-${this._id}`);
        if (addButton) {
...
class User {
    ...
    cartHTMLElement() {
        ...
        this._cart.forEach(item => {
            ...
            `;
            const removeOneButton = itemDiv.querySelector(`#remove-one-${item.itemid}`);
            if (removeOneButton) {
            ...
            const removeAllButton = itemDiv.querySelector(`#remove-all-${item.itemid}`);
            if (removeAllButton) {
...
(_a = document.getElementById('login-button')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', User.loginUser);
// Create an instance of Shop and initialize the shop and cart elements on the page
const shop = new Shop();
const shopDiv = document.getElementById('shop');
const cartDiv = document.getElementById('cart');
shopDiv.appendChild(shop.showItems());
cartDiv.appendChild(((_b = User.myUser) === null || _b === void 0 ? void 0 : _b.cartHTMLElement()) || document.createElement('div'));
